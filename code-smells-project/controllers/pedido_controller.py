...
from services.pedido_service import notificar_pedido_criado, notificar_status_alterado
...
def listar_todos_pedidos():
    return jsonify({"dados": pedido_model.get_todos_pedidos(), "sucesso": True}), 200
...
def atualizar_status_pedido(pedido_id):
    ...
    notificar_status_alterado(pedido_id, novo_status)
